terraform {
  ...
  backend "azurerm" {
    ...
    // resource_group_name, storage_account_name, container_name (tfstate-prod), key (publisher/vd-core/prod/main/terraform.tfstate)
    resource_group_name  = "rg-tfstate-prod"
    storage_account_name = "tfstateprod"
    container_name       = "tfstate-prod"
    key                  = "publisher/vd-core/prod/main/terraform.tfstate"
  }
