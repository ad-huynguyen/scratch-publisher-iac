...
module "storage" {
  ...
  private_dns_zone_ids = {
    blob  = "/subscriptions/${var.metadata.subscriptionId}/resourceGroups/${var.metadata.resourceGroupName}/providers/Microsoft.Network/privateDnsZones/${module.naming.private_dns_zones["storage_blob"]}"
    queue = "/subscriptions/${var.metadata.subscriptionId}/resourceGroups/${var.metadata.resourceGroupName}/providers/Microsoft.Network/privateDnsZones/${module.naming.private_dns_zones["storage_queue"]}"
    table = "/subscriptions/${var.metadata.subscriptionId}/resourceGroups/${var.metadata.resourceGroupName}/providers/Microsoft.Network/privateDnsZones/${module.naming.private_dns_zones["storage_table"]}"
  }
}
